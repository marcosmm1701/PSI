...
// "export PYTHON3=~/.virtualenvs/practica2_venv/bin/python\n" +
//
...
//const PYTHON = "/home/marcos1701/Escritorio/Marcos.M/PSI/PSI/P4/chesstournament-client/venv/bin/python3"
//const MANAGE = "/home/marcos1701/Escritorio/Marcos.M/PSI/PSI/P3/chesstournament/manage.py"
...
Cypress.Commands.add(
    ...
    (
        ...
        cy.get("[data-cy=name-cypress-test]")
            .scrollIntoView()
            .type(tournament_name, { force: true });
        ...
        cy.get("[data-cy=single_round_robin-cypress-test]")
            .scrollIntoView()
            .select(tournament_type, { force: true });
        // boardtype lichess
        cy.get("[data-cy=boardtype-cypress-test]")
            .scrollIntoView()
            .select(tournament_board_type, { force: true });
