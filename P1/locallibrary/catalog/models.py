...
class Language(models.Model):
    ...
    name = models.CharField(
        ...
        unique=True,
        help_text=(
            "Enter the book's natural language "
...
class Book(models.Model):
    ...
    isbn = models.CharField(
        'ISBN',
        max_length=13,  # etiqueta como "ISBN", sino el valor sería "Isbn"
        unique=True,
        help_text=(
...
class BookInstance(models.Model):
    ...
    def is_overdue(self):
        """Determines if the book is overdue
            based on due date and current date."""
    ...
    class Meta:
        ...
        permissions = (
            ...
            ("can_see_borrowed_books", "Can see borrowed books"),
        )
